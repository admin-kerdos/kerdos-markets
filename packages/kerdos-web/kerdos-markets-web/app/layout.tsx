...
import HeaderSpacer from "./HeaderSpacer.client";
      ...
      <body>
        <ThemeProvider>
          <HeroCarouselProvider markets={markets}>
            ...
            {/* Route-aware spacer (hidden on /markets/[slug]) */}
            {/*
              NOTE: This component is client-side and decides whether to render the spacer
              based on the pathname. It prevents double offset on the detail page.
            */}
            <HeaderSpacer />
